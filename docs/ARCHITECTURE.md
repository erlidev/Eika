...
Two Go binaries, the agent core, the sandbox machinery agents run in, one
frontend, and a three-service compose stack. Nothing wires the agent core or
the workspace host into the server yet; that is phase 4.
